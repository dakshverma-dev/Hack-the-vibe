          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              {view === 'home' ? (
                ...
                <button onClick={() => setView('home')} className="flex items-center text-gray-600 hover:text-gray-900 transition-colors">
                  <ArrowLeft className="w-5 h-5 mr-2" />
                  Back to Dashboard
                </button>
              )}
      ...
      {view === 'home' && (
        <div className="max-w-4xl mx-auto px-6 py-16">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-500 text-lg">Create a new interview session or review past results</p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <Link
              href="/practice"
              className="group bg-white rounded-2xl shadow-sm border border-gray-200 hover:border-purple-300 hover:shadow-xl transition-all duration-300 p-8 flex flex-col items-center text-center space-y-5"
            >
              <div className="w-20 h-20 bg-gradient-to-br from-purple-600 to-blue-600 rounded-2xl flex items-center justify-center shadow-lg shadow-purple-200 group-hover:scale-110 transition-transform duration-300">
                <Plus className="w-10 h-10 text-white" />
              </div>
              <div>
                <h3 className="text-xl font-bold text-gray-900 mb-2">Create New Interview</h3>
                <p className="text-gray-500">Start a new coding interview session with AI-powered questions and real-time feedback.</p>
              </div>
            ...
            <button
              ...
              className="group bg-white rounded-2xl shadow-sm border border-gray-200 hover:border-blue-300 hover:shadow-xl transition-all duration-300 p-8 flex flex-col items-center text-center space-y-5"
            >
              <div className="w-20 h-20 bg-gradient-to-br from-blue-600 to-cyan-600 rounded-2xl flex items-center justify-center shadow-lg shadow-blue-200 group-hover:scale-110 transition-transform duration-300">
                <History className="w-10 h-10 text-white" />
              </div>
              <div>
                <h3 className="text-xl font-bold text-gray-900 mb-2">View Past Interviews</h3>
                <p className="text-gray-500">Review previous interview reports, scores, and detailed candidate feedback.</p>
              </div>
